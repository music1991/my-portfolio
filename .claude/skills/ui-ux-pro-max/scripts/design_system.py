...
def _slugify(name: str, fallback: str = "default") -> str:
    """Turn arbitrary input into a safe single path segment.

    Strips everything except lowercase alphanumerics/-/_ so values like
    "../../etc" or "a/b\\c" can't escape the intended output directory
    (they collapse to "etc" / "a-b-c" instead of traversing).
    """
    import re
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    ...
    # Use project name for project-specific folder. _slugify neutralizes path
    # separators and ".." so a crafted project name/page can't write outside
    ...
    if page:
        page_file = pages_dir / f"{_slugify(page, fallback='page')}.md"
